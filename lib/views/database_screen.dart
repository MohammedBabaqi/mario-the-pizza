              ...
              children: [
                Row(
                  children: [
                    ...
                    Text('Storage Engine Details', style: AppTypography.titleMedium.copyWith(color: context.text, fontWeight: FontWeight.bold)),
                  ],
                ),
                const Divider(height: 24),
                _buildInfoRow('Storage System', kIsWeb ? 'SharedPreferences (browser storage)' : 'SQLite 3 (sqflite)'),
                _buildInfoRow('Database File', kIsWeb ? 'Not used on Web' : 'mario_pizza.db'),
                _buildInfoRow('Food Store', 'pizzas (${_pizzas.length} records)'),
                _buildInfoRow('User Store', 'users (${_users.length} records)'),
                _buildInfoRow('Storage Schema', 'v2'),
